...
acCheckPasswordStrength(*password) {if(strlen(*password) <6) {msiDeleteDisallowed; }}
...
acSetRescSchemeForCreate {msiSetDefaultResc("dfc-defaultResc","null"); }
acSetRescSchemeForRepl {msiSetDefaultResc("dfc-defaultResc","null"); }
